...
async function main() {
  ...
  const instructor = await prisma.instructor.upsert({
    ...
    create: {
      ...
      birthDate: new Date('1978-05-20T00:00:00.000Z'),
  ...
  const extraInstructors = [
    {
      ...
      birthDate: new Date('1985-03-12T00:00:00.000Z'),
      educationLevel: 'Superior Completo',
      plate: 'DEMO-0002',
    ...
    },
    {
      ...
      birthDate: new Date('1980-11-07T00:00:00.000Z'),
    ...
    },
    {
      ...
      birthDate: new Date('1983-06-14T00:00:00.000Z'),
      educationLevel: 'Superior Completo',
      plate: 'DEMO-0004',
    ...
    },
    {
      ...
      birthDate: new Date('1994-09-30T00:00:00.000Z'),
      educationLevel: 'Superior Completo',
      plate: 'DEMO-0005',
  ...
  const aluno3 = await prisma.student.upsert({
    ...
    create: {
      ...
      cpf: '33344455500',
      phone: '67988880003',
      birthDate: new Date('2001-11-05T00:00:00.000Z'),
  ...
  const aluno4 = await prisma.student.upsert({
    ...
    create: {
      ...
      cpf: '44455566600',
      phone: '67988880004',
      birthDate: new Date('1999-05-10T00:00:00.000Z'),
